...
export default function UserInfoCard() {
  ...
  const handleSave = () => {
    // Handle update logic with PATCH /api/users/:id
  ...
  return (
    <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        ...
        <button
          onClick={openModal}
          className="flex items-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow hover:bg-gray-50"
        >
          Edit
        </button>
      </div>
